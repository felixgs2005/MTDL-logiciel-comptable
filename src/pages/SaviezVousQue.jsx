...
const facts = [
  ...
  },
  {
    ...
    a: 'Les taux de cotisation à la Régie des rentes du Québec (RRQ) et à lassurance-emploi (AE) sont révisés annuellement. Il est essentiel de mettre à jour votre logiciel de paie au 1er janvier.',
  },
  {
    cat: 'Technologie',
  ...
  {
    cat: 'Déductions',
    q: 'Saviez-vous que les repas daffaires sont déductibles à 50 % ?',
  ...
  },
  {
    ...
    a: 'Au Québec, les entreprises ont lobligation légale de conserver leurs documents comptables et fiscaux pendant au moins 6 ans à compter de la fin de lannée fiscale concernée.',
  },
]
